...
public class BillDetail extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action == null) {
            doGet_DisplayBillDetail(request, response);
        } 
...
//        }
    ...
    protected void doGet_DisplayBillDetail(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        ...
        List<BillDetailDTO> list = dao.getBillDetail(bID);
